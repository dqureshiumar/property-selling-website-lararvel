                        ...
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col">{{ __('Sold/Rented') }}</th>
                                    <th scope="col"></th>
                                </tr>
                            </thead>
                            <tbody>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    @if (auth()->user()->isAdmin == 1 || $property->userid == auth()->user()->id)
                                                        <a class="dropdown-item" href="{{ route('sold', [$property->id]) }}">{{ __('Sold') }}</a>
                                                        <a class="dropdown-item" href="{{ route('rent', [$property->id]) }}">{{ __('Rented') }}</a>
