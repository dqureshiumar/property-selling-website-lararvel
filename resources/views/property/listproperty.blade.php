...
<head>
	...
	<title>All Properties | Homex</title>
	<!-- FAVICON -->
...
<body class="inner-pages">
	...
	<section class="properties-list featured portfolio blog">
		<div class="container">
            ...
            <form method="POST" action="{{route('search_properties')}}">
                @csrf
            <div class="container row">
                
                <div class="col-lg-10 col-sm-9 col-md-9"><input type="text" name="search" id="search" class="form-control" placeholder="Search by Location"></div>
                <div class="col-lg-1 col-sm-3 col-md-3"><button class="btn btn-danger" type="submit" id="search" class="form-control"><i class="fa fa-search"></i></button></div>                
            </div>
            </form>
			<!-- Block heading end -->
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="info">
                                        ...
                                        <a class="in-p" href="mailto:dqureshiumar@gmail.com" style="color:white">&nbsp;TCET Students</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
