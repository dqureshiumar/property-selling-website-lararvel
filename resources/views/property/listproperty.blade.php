...
<head>
	...
	<title>All Properties | IndiAvenue</title>
	<!-- FAVICON -->
...
<body class="inner-pages">
	...
	<section class="properties-list featured portfolio blog">
		<div class="container">
            ...
            <form method="POST" action="{{route('all-properties')}}">
            @csrf
            <div class="container row">
                
                <div class="col-lg-10 col-sm-9 col-md-9"><input type="text" name="search" id="search" class="form-control" placeholder="Search for Properties"></div>
                <div class="col-lg-1 col-sm-3 col-md-3"><button class="btn btn-danger" type="submit" name="search" id="search" class="form-control"><i class="fa fa-search"></i></button></div>                
            </div>
            </form>
			<!-- Block heading end -->
