...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::post('profile-update', 'PorpertyController@profile_update')->name('profile_update');
});
Route::get('/redirect', 'SocialAuthGoogleController@redirect');
Route::get('/callback', 'SocialAuthGoogleController@callback');
Route::any('/all-properties', 'DemoController@allprops')->name('all-properties');

Route::post('/search_properties', 'DemoController@search_properties')->name('search_properties');
//Payment Routes
